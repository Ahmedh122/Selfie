    ...
    <div className="background overflow-hidden bg-[#313338] h-[100vh] w-screen flex items-center justify-center  ">
      <div className="t-0 l-0 w-[100%] h-[100%]  flex absolute overflow-hidden">
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i calendar1 stroke-[#242529]  "
        >
          <path
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i calendar2 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i calendar3 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i book1 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i book2 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i book3 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i globe1 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i globe2 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i globe3 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i clock1 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i clock2 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-10 i clock3 stroke-[#242529] "
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
