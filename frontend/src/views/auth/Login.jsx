...
const Login = () => {
  return (
    <div className="bg-[#313338] min-h-[100vh] flex items-center justify-center">
      <div className="bg-[#232428] flex rounded-2xl shadow-2xl max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8 md:px-16">
          ...
          <form action="" className="flex flex-col gap-4">
            ...
            <button className="bg-violet-800 rounded-xl text-white py-2 hover:scale-105 duration-300">
              Login
            </button>
          </form>
          ...
          <div className="mt-3 text-xs flex justify-between items-center text-slate-500">
            ...
            <Link to="/register">
              <button className="py-2 px-5 bg-[#111111] border  rounded-xl hover:scale-110 duration-300">
                Register
              </button>
            </Link>
          </div>
